...
def main():
    ...
    print(
        f"  Location: Prague ({location.latitude}°N, {location.longitude}°E, {location.altitude}m)"
    )
    ...
    try:
        ...
        print(
            f"Specific Yield: {results.statistics.total_energy_kwh / (total_power_wp/1000):.0f} kWh/kWp"
        )
        ...
        for _, row in monthly.iterrows():
            ...
            print(
                f"{month_name:<12} {row['total_energy_kwh']:>10.1f}     "
        ...
        if not jan_data.empty:
            ...
            print("(Based on typical January weather in Prague)")
            print()
